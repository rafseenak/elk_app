...
Future<Position> determinePosition() async {
  ...
  if (!serviceEnabled) {
    ...
    return Future.error(const LocationException(
        statusCode: LocationStatusCode.locationDisabled,
  ...
  if (permission == LocationPermission.denied) {
    ...
    if (permission == LocationPermission.denied) {
      ...
      return Future.error(const LocationException(
          statusCode: LocationStatusCode.locationPermiDenied,
  ...
  if (permission == LocationPermission.deniedForever) {
    ...
    return Future.error(const LocationException(
        statusCode: LocationStatusCode.locationPermissionPermentlyDenied,
        message:
